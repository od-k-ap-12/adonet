...
namespace adonet.Migrations
{
    ...
    [Migration("20240301071426_InternationalName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("adonet.EFContext.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("adonet.EFContext.Manager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("adonet.EFContext.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("adonet.EFContext.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("adonet.EFContext.Manager", b =>
                {
                    b.HasOne("adonet.EFContext.Manager", "Chief")
                        .WithMany("Subordinates")
                        .HasForeignKey("IdChief");

                    b.HasOne("adonet.EFContext.Department", "MainDepartment")
                        .WithMany("MainWorkers")
                        .HasForeignKey("IdMainDep")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("adonet.EFContext.Department", "SecondaryDepartment")
                        .WithMany("SecondaryWorkers")
            ...
            modelBuilder.Entity("adonet.EFContext.Sale", b =>
                {
                    b.HasOne("adonet.EFContext.Manager", "Manager")
                        .WithMany("Sales")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("adonet.EFContext.Product", "Product")
                        .WithMany("Sales")
            ...
            modelBuilder.Entity("adonet.EFContext.Department", b =>
                {
                    b.Navigation("MainWorkers");

                    b.Navigation("SecondaryWorkers");
                });
